...
Train models on raw ECG/EEG/respiratory waveforms. Understand both the pure 1D CNN approach and the spectrogram-to-2D-CNN approach.

## Key references
- Hannun et al. 2019 (Stanford ECG paper, Nature Medicine)
- Kiranyaz et al. 2021 (1D CNN survey)
